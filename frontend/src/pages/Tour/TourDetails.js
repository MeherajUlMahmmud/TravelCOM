                    ...
                    >
                        <div className="modal-dialog">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    <h5>
                                        Are you sure you want to close booking
                                        for <u>{tour.name}</u>?
                                    </h5>
                                </div>
                                <div className="modal-footer">
...
function BookedThisTour() {
    return (
        <p className="h5 mt-3">
            <i className="fas fa-check-circle text-success"></i> You have booked
            this tour
        </p>
    );
}
